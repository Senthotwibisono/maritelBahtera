...
<body class="theme-dark" style="overflow-y: auto;">
                ...
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logoicon" style="left: -1000;">
                            <a href="/bc-p2/dashboard"><img src="{{asset('logo/IntiMandiri.png')}}" alt="Logo" style="position: relative; left: 10px;" srcset=""></a>
                        </div>
                        <!-- Dark or Light mode -->
  ...
  <script type="text/javascript" src="//cdn.jsdelivr.net/momentjs/latest/moment.min.js"></script>
    ...
    $(document).ready(function() {
        ...
        $(".alasanSegel").select2({
        dropdownParent: $('#lockModal .modal-content')
        });
    });
    </script>
